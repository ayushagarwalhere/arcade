// GENERATED by scripts/sync-core.mjs from packages/agents/src/mapper.ts — do not edit here.
/**
 ...
 */
import type { AttackSurface, Finding, Project, SurfaceEdge, SurfaceNode } from "../core/types";
