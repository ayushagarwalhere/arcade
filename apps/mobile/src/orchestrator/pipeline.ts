// GENERATED by scripts/sync-core.mjs from packages/orchestrator/src/pipeline.ts — do not edit here.
/**
 ...
 */
import type { WorkspaceFs } from "../core/fs";
import type { Finding, Project } from "../core/types";
import { scanWorkspace, type Scan, type ScanProgress } from "../core/scanner";
import { bySeverity } from "../core/rules";
import { mapProject, mapSurface } from "../agents/mapper";
import { reproduce } from "../agents/attacker";
import { defend } from "../agents/defender";
import { remediate } from "../agents/remediator";
import { verify } from "../agents/verifier";
import { LOCAL_PROVIDER, type AssessmentProvider } from "../agents/provider";
